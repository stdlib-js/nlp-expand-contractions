...
```javascript
expandContractions = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/nlp-expand-contractions@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/nlp-expand-contractions@umd/bundle.js"></script>
```
